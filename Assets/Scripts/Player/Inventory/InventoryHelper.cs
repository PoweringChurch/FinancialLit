...
public class InventoryHelper : MonoBehaviour
{
    ...
    void Start()
    {
        FurnitureInventoryUI.Instance.SetInventory(inventory);
    }
    ...
    public void AddItem(FurnitureData itemData, int count)
    {
        ...
        FurnitureInventoryUI.Instance.UpdateInventoryItem(itemData.itemName);
    }
    // removes an item to the inventory, additionally updating ui
    public void RemoveItem(string itemName, int count)
    {
        inventory.RemoveItem(itemName, count);
        FurnitureInventoryUI.Instance.UpdateInventoryItem(itemName);
    }
